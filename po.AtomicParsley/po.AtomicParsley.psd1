#
# Module manifest for module 'po.AtomicParsley'
#
# Generated by: Sean Powell
#
...
FunctionsToExport = @('Invoke-AtomicParsleyCommand','Read-AtomicParsleyAtoms', 'Write-AtomicParsleyAtoms')

# Cmdlets to export from this module, for best performance, do not use wildcards and do not delete the entry, use an empty array if there are no cmdlets to export.
# CmdletsToExport = '*'

# Variables to export from this module
# Listing the Variable here doesn't work. It has to be explicitly exported in the psm1 file.
VariablesToExport = @('AP_ATOMS')
